...
/* harmony import */ var _modules_open_element__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/open-element */ "./js/modules/open-element.js");
/* harmony import */ var _modules_adjust_footer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/adjust-footer */ "./js/modules/adjust-footer.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_adjust_footer__WEBPACK_IMPORTED_MODULE_4__["adjustFooter"])();
  // Modules
  // ---------------------------------
  _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["moreAboutButton"].addEventListener('click', _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["onAboutButtonClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["linksButton"].addEventListener('click', _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["onFooterLinksClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["linksHeader"].addEventListener('click', _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["onFooterLinksClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["addressButton"].addEventListener('click', _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["onFooterAddressClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["addressHeader"].addEventListener('click', _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["onFooterAddressClick"]);
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    var lockBtnElement = document.querySelector('.lock');
    lockBtnElement.addEventListener('click', function () {
      return window.focusLock.lock('.lock-block');
    });
  });
});
...
/***/ "./js/modules/adjust-footer.js":
/*!*************************************!*\
  !*** ./js/modules/adjust-footer.js ***!
  \*************************************/
/*! exports provided: adjustFooter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "adjustFooter", function() { return adjustFooter; });
var adjustFooter = function adjustFooter() {
  var footerList = document.querySelector('[data-footer-navigation-list]');
  var footerListElements = footerList.querySelectorAll('li');
  if (footerListElements.length > 8 && footerListElements.length <= 12) {
    footerList.style.maxHeight = '250px';
    footerListElements.forEach(function (el) {
      return el.style.maxWidth = '160px';
    });
  } else if (footerListElements.length > 12) {
    footerList.style.maxHeight = '300px';
    footerListElements.forEach(function (el) {
      return el.style.maxWidth = '130px';
    });
  }
};
...
/***/ "./js/modules/open-element.js":
/*!************************************!*\
  !*** ./js/modules/open-element.js ***!
  \************************************/
/*! exports provided: linksButton, addressButton, linksHeader, addressHeader, onFooterAddressClick, onFooterLinksClick, openElement, onModalButtonClick, onAboutButtonClick, moreAboutButton, aboutExtra, modalFrame, callButton, closeButton, overlay */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "linksButton", function() { return linksButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addressButton", function() { return addressButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "linksHeader", function() { return linksHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addressHeader", function() { return addressHeader; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onFooterAddressClick", function() { return onFooterAddressClick; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onFooterLinksClick", function() { return onFooterLinksClick; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moreAboutButton", function() { return moreAboutButton; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aboutExtra", function() { return aboutExtra; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "modalFrame", function() { return modalFrame; });
...
var openElement = function openElement(elements, event, switcher) {
  event.preventDefault();
  _toConsumableArray(elements).forEach(function (element) {
    element.classList.toggle(switcher);
  });
};
var openAccordeonElement = function openAccordeonElement(elements, surplus) {
  openElement(elements, event, 'is-deactivate');
  surplus.classList.toggle('is-lost');
};
var aboutExtra = document.querySelectorAll('[data-about-extra]');
var moreAboutButton = document.querySelector('[data-about-button]');
...
var modalFrame = document.querySelectorAll('[data-modal]');
var callButton = document.querySelector('[data-open-modal]');
var closeButton = document.querySelector('[data-close-button]');
var overlay = document.querySelector('[data-close-modal]');
...
var addressList = document.querySelectorAll('[data-footer-address-list]');
var addressHeader = document.querySelector('[data-footer-address-header]');
var addressButton = document.querySelector('[data-footer-address-button]');
var addressSign = document.querySelector(['[data-address-sign]']);
var onFooterAddressClick = function onFooterAddressClick() {
  openAccordeonElement(addressList, addressSign);
};
var linksButton = document.querySelector('[data-footer-navigation-button]');
var linksHeader = document.querySelector('[data-footer-navigation-header]');
var linksList = document.querySelectorAll('[data-footer-navigation-list]');
var linksSign = document.querySelector('[data-navigation-sign]');
var onFooterLinksClick = function onFooterLinksClick() {
  ...
  _createClass(ScrollLock, [{
    ...
    value: function disableScrolling() {
      ...
      if (this._getScrollbarWidth()) {
        ...
        document.querySelector('.navigation').style.paddingRight = "".concat(this._getScrollbarWidth(), "px");
