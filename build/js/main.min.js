...
/* harmony import */ var _modules_open_element__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/open-element */ "./js/modules/open-element.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  // Modules
  // ---------------------------------
  _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["moreAboutButton"].addEventListener("click", _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["onAboutButtonClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["linksButton"].addEventListener("click", _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["onFooterLinksClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["linksHeader"].addEventListener("click", _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["onFooterLinksClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["addressButton"].addEventListener("click", _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["onFooterAddressClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["addressHeader"].addEventListener("click", _modules_open_element__WEBPACK_IMPORTED_MODULE_4__["onFooterAddressClick"]);
  ...
  window.addEventListener("load", function () {
    ...
    window.form = form;
    form.init();
    document.querySelector(".lock-block").addEventListener("click", function () {
      return window.focusLock.lock("[data-modal]");
    });
    document.querySelector(".lock-block").addEventListener('click', function () {
      return window.focusLock.unlock();
    });
    document.querySelector(".lock-block").addEventListener('click', function () {
      return window.focusLock.unlock(false);
    });
