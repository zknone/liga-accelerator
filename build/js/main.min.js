...
window.addEventListener("DOMContentLoaded", function () {
  ...
  // Modules
  // ---------------------------------
  _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["callButton"].addEventListener("click", _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["onModalButtonClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["callButton"].addEventListener("click", function () {
    document.querySelector("[data-input-name]").focus({
      focusVisible: true
    });
  });
  _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["closeButton"].addEventListener("click", _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["onModalButtonClick"]);
  _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["overlay"].addEventListener("click", _modules_open_element__WEBPACK_IMPORTED_MODULE_3__["onModalButtonClick"]);
  document.addEventListener("keydown", function (evt) {
    if (evt.key === "Escape") {
      Object(_modules_open_element__WEBPACK_IMPORTED_MODULE_3__["onModalButtonClick"])();
    }
  });
...
var openElement = function openElement(elements, event) {
  event.preventDefault();
  _toConsumableArray(elements).forEach(function (element) {
    element.classList.toggle("is-active");
  });
};
var openAccordeonElement = function openAccordeonElement(element, surplus) {
...
var addressList = document.querySelector("[data-footer-address-list]");
...
var linksList = document.querySelector("[data-footer-navigation-list]");
